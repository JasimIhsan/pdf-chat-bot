...
export function FAQSection() {
   ...
   return (
      <section id="faq" className="py-16 sm:py-24 relative z-10 scroll-mt-16">
         <div className="container mx-auto px-4 sm:px-6 md:px-8 max-w-3xl">
            <div className="text-center space-y-3 sm:space-y-4 mb-8 sm:mb-12">
               <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold tracking-tight text-foreground">Frequently Asked Questions</h2>
               <p className="text-muted-foreground text-sm sm:text-base">Everything you need to know about the product and architecture.</p>
            </div>

            <div className="p-4 sm:p-6 md:p-8 rounded-2xl sm:rounded-3xl bg-zinc-950/40 backdrop-blur-2xl border border-white/10 shadow-2xl">
               <BouncyAccordion
                  items={faqItems}
                  classNames={{
                     title: "text-sm sm:text-[15px] font-medium text-foreground whitespace-normal break-words",
                     description: "text-xs sm:text-sm leading-relaxed text-muted-foreground",
                     trigger: "py-3 sm:py-4 px-3 sm:px-5",
                     content: "px-3 sm:px-5",
                  }}
               />
            </div>
         </div>
